...
FROM tb_object_departamento WHERE JSON_EXTRACT(JSONVALUE,"$.Cpf_Gerente") = ‘33344555587’;

SELECT JSON_EXTRACT(JSONVALUE, "$.Numero_Projeto"), AVG(JSON_EXTRACT(JSONVALUE, "$.Horas"))
